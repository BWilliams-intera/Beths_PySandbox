...
# installed.
TCL_PREFIX='C:/Beths_PySandbox'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/Beths_PySandbox'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-LC:/Beths_PySandbox/lib -ltcl86'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/Beths_PySandbox/include'
...
TCL_PACKAGE_PATH='C:/Beths_PySandbox/lib C:/Beths_PySandbox/lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/Beths_PySandbox/lib -ltclstub86'
...
TCL_STUB_LIB_PATH='C:/Beths_PySandbox/lib/tclstub86.lib'
